// 2D coordinate system for position and orientation of the robot. The angle is in radians, and the axis angle is the angle of the robot's forward direction relative to the x-axis.
#ifndef COORDINATE_H
#define COORDINATE_H
...
Coordinate om_coordinate_cross_product(const Coordinate* self, const Coordinate* other);
